...
test ("One dollar should be 146.17 yens", function () {
    ...
    const expected = 3.5 * 146.16;
    expect(fromDollarToYen(3.5)).toBe(511.595); // 1 dollar is 146.17 yens, then 3.5 dollars should be = (3.5 * 146.17)
})

test ("1000 yens should be 5.556 pounds", function () {
    const yens = fromYenToPound(1000);
    const expected = 1000 / 179.98;
